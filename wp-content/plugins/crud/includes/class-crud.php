...
class Crud
{
	...
	private function load_dependencies()
	{
		...
		require_once plugin_dir_path(dirname(__FILE__)) . 'public/controller/homepage.php';
	...
	private function define_public_hooks()
	{
		...
		$this->loader->add_shortcode('greetings_code', $homepage, 'irent_greetings');

		$this->loader->add_action('wp_ajax_irent_saveform', $homepage, 'wp_ajax_irent_saveform');
	}
